  ...
  <aside class="left-nav" :class="{ collapsed: layout.navCollapsed }">
    ...
    <nav class="nav-list">
      ...
      <template v-if="auth.canPlanner()">
        ...
        <router-link to="/forecast/dashboard"  class="nav-item" active-class="active">Dashboard</router-link>
        ...
        <router-link to="/forecast/exports"    class="nav-item" active-class="active">Export</router-link>
      </template>
      ...
      <router-link to="/reports/stock-on-hand-grid" class="nav-item" active-class="active">Stock (SOH)</router-link>
